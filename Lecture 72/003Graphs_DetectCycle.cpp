		...
		for (T neighbour : neighbourList) {
			if (visited.find(neighbour) == visited.end()) {
				...
				if (dfsHelper(neighbour, visited, source)) {
					// you've found a cycle in a subcomponent of of s
					// therefore you've found a cycle in the component of s
					return true;
				}
				...
				if (neighbour != parent) {
					...
					// the edge from source to neighbour is a backedge

					// therefore your component has a cycle
